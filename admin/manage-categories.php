                ...
                <div class="col-md-12">
                    <div class="admin-card">
                        <div class="card-header">
                           <div class="row">
                               <div class="col-md-6"><strong><i class="fa fa-file-archive-o"></i> Categories Listing</strong></div>
                               <div class="col-md-6 text-right"><a href="add-category.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Category</a></div>
                           </div>
                        </div>
                        <div class="card-body">
